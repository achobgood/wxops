...
def _build_sidebar_nav(executive_only: bool) -> str:
    ...
    tech_items = [
        ...
        ("I", "#audio-assets", "Audio Assets"),
        ("J", "#coverage", "Data Coverage"),
        ("K", "#gateways", "Gateways & Analog Ports"),
        ("L", "#call-features", "Call Features"),
        ("M", "#button-templates", "Button Templates"),
        ("N", "#device-layouts", "Device Layouts"),
        ("O", "#softkeys", "Softkey Migration"),
        ("P", "#cloud-managed", "Cloud-Managed"),
        ("Q", "#feature-gaps", "Feature Gaps"),
        ("R", "#manual-reconfig", "Manual Reconfig"),
        ("S", "#planning-inputs", "Planning Inputs"),
        ("T", "#recording-inventory", "Call Recording"),
        ("U", "#snr-inventory", "Single Number Reach"),
        ("V", "#caller-id-xforms", "Caller ID Transforms"),
        ("W", "#extension-mobility", "Extension Mobility"),
        ("X", "#dect-networks", "DECT Networks"),
    ]
