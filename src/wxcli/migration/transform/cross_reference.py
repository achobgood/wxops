...
# Native MPP: factory MPP firmware, direct migration
...
# Firmware Convertible: Enterprise phones that can be converted to MPP firmware
# (from cucm-wxc-migration.md line 368: "Enterprise 78xx (7821/7841/7861),
#  Enterprise 88xx (8845/8865)")
_CONVERTIBLE_PATTERNS = {
    "Cisco 7821", "Cisco 7841", "Cisco 7861",
    "Cisco 8845", "Cisco 8865",
    "Cisco IP Phone 7821", "Cisco IP Phone 7841", "Cisco IP Phone 7861",
    "Cisco IP Phone 8845", "Cisco IP Phone 8865",
}

# Everything else is incompatible
# (from cucm-wxc-migration.md line 369: "79xx, 99xx, 69xx, 39xx, older 78xx (7811)")
...
def classify_phone_model(model: str | None) -> DeviceCompatibilityTier:
    ...
    # (e.g., 7811 is incompatible per cucm-wxc-migration.md line 369).
    _INCOMPATIBLE_WITH_MPP = {"7811", "7911", "7912", "7940", "7941", "7942",
        ...
        for lg_data in self.store.get_objects("line_group"):
            ...
            for member in state.get("members", []):
                ...
                if isinstance(member, dict):
                    dn_num = member.get("directoryNumber") or member.get("pattern")
                    # Partition may be a ref or plain string
