...
description: |
  ...
  or directly via the `query-live` skill.
...
|-------------------|--------------|-----------|
| Users, person settings (voicemail, forwarding, DND, recording, caller ID, permissions) | people-and-settings | `Read .codex/skills/query-live/domains/people-and-settings.md` |
| Hunt groups, call queues, auto attendants, paging, call park, pickup, voicemail groups | features | `Read .codex/skills/query-live/domains/features.md` |
| Trunks, route groups, route lists, dial plans, translation patterns, PSTN | routing | `Read .codex/skills/query-live/domains/routing.md` |
| Phone numbers, number inventory, assignment status, available numbers | numbers | `Read .codex/skills/query-live/domains/numbers.md` |
| Call history, CDR, call volume, missed calls, busiest hours | call-history | `Read .codex/skills/query-live/domains/call-history.md` |
| "What happens when someone calls...", call path tracing, schedule evaluation | call-flow-trace | `Read .codex/skills/query-live/domains/call-flow-trace.md` |
