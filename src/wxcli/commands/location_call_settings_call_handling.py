...
def update(
    location_id: str = typer.Argument(help="locationId"),
    enable_unknown_extension_route_policy: bool = typer.Option(None, "--enable-unknown-extension-route-policy/--no-enable-unknown-extension-route-policy", help=""),
...
def list_access_codes(
    ...
    if output == "json":
        ...
        print_table(items, columns=[('Code', 'code'), ('Description', 'description')], limit=limit)
