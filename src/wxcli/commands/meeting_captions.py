...
app = typer.Typer(help="Manage Webex Calling closed-captions.")
...
@app.command("list-meeting-closed-captions")
def list_meeting_closed_captions(
    meeting_id: str = typer.Option(None, "--meeting-id", help="Unique identifier for the [meeting instance](/docs/meetings#"),
    output: str = typer.Option("table", "--output", "-o", help="Output format: table|json"),
    limit: int = typer.Option(0, "--limit", help="Max results (0=all for paginated endpoints, API default for non-paginated)"),
    offset: int = typer.Option(0, "--offset", help="Start offset"),
...
def list_download(
    closed_caption_id: str = typer.Argument(help="closedCaptionId"),
    format_param: str = typer.Option(None, "--format", help="Format for the downloaded meeting closed caption snippets."),
    meeting_id: str = typer.Option(None, "--meeting-id", help="Unique identifier for the [meeting instance](/docs/meetings#"),
    output: str = typer.Option("table", "--output", "-o", help="Output format: table|json"),
    limit: int = typer.Option(0, "--limit", help="Max results (0=all for paginated endpoints, API default for non-paginated)"),
    offset: int = typer.Option(0, "--offset", help="Start offset"),
