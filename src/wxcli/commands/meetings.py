...
app = typer.Typer(help="Manage Webex Calling meetings.")
...
def update_registration(
    ...
    """Update Meeting Registration Form\n\nExample --json-body:\n  '{"requireCompanyName":"...","requireAddress1":"...","requireAddress2":"...","requireCity":"...","hostEmail":"...","requireZipCode":"..."}'."""
    api = get_api(debug=debug)
    url = f"https://webexapis.com/v1/meetings/{meeting_id}/registration"
    if json_body:
        body = json.loads(json_body)
...
def create(
    ...
    """Register a Meeting Registrant\n\nExample --json-body:\n  '{"lastName":"...","address1":"...","address2":"...","city":"...","customizedQuestions":[{"questionId":"...","answers":"..."}],"zipCode":"..."}'."""
    api = get_api(debug=debug)
    url = f"https://webexapis.com/v1/meetings/{meeting_id}/registrants"
    params = {}
    if current is not None:
...
def list_meetings(
    ...
    max: str = typer.Option(None, "--max", help="Limit the maximum number of meetings in the response, up to"),
...
def create_meetings(
    ...
    """Create a Meeting\n\nExample --json-body:\n  '{"scheduledType":"...","allowAuthenticatedDevices":"...","meetingOptions":{"enabledFileTransfer":"...","enabledUCFRichMedia":"...","enabledChat":"...","enabledVideo":"...","enabledPolling":"...","enabledNote":"..."},"trackingCodes":[{"name":"...","value":"..."}],"attendeePrivileges":{"enabledShareContent":"...","enabledSaveDocument":"...","enabledPrintDocument":"...","enabledAnnotate":"...","enabledViewParticipantList":"...","enabledViewThumbnails":"..."},"agenda":"..."}'."""
    api = get_api(debug=debug)
    url = f"https://webexapis.com/v1/meetings"
    if json_body:
        body = json.loads(json_body)
...
def create_bulk_insert(
    ...
    """Batch register Meeting Registrants\n\nExample --json-body:\n  '{"items":[{"lastName":"...","address1":"...","address2":"...","city":"...","customizedQuestions":"...","zipCode":"..."}]}'."""
    api = get_api(debug=debug)
...
def update_meetings(
    ...
    """Update a Meeting\n\nExample --json-body:\n  '{"allowFirstUserToBeCoHost":"...","allowAuthenticatedDevices":"...","meetingOptions":{"enabledFileTransfer":"...","enabledUCFRichMedia":"...","enabledChat":"...","enabledVideo":"...","enabledPolling":"...","enabledNote":"..."},"trackingCodes":[{"name":"...","value":"..."}],"attendeePrivileges":{"enabledShareContent":"...","enabledSaveDocument":"...","enabledPrintDocument":"...","enabledAnnotate":"...","enabledViewParticipantList":"...","enabledViewThumbnails":"..."},"agenda":"..."}'."""
    api = get_api(debug=debug)
    url = f"https://webexapis.com/v1/meetings/{meeting_id}"
    if json_body:
        body = json.loads(json_body)
