...
def cmd_list(
    ...
    emit(items, output=output, fields=fields, columns=[('ID', 'id'), ('Billing Start Date', 'billingStartDate'), ('Billing End Date', 'billingEndDate'), ('Status', 'status'), ('Type', 'type')], limit=limit)
