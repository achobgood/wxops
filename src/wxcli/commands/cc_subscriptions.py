...
def update(
    id: str = typer.Argument(help="id"),
    description: str = typer.Option(None, "--description", help="Client-defined string describing the subscription."),
    destination_url: str = typer.Option(None, "--destination-url", help="URL to which webhooks will be posted. Must be HTTPS on an IA"),
...
def create_subscriptions(
    ...
    secret: str = typer.Option(None, "--secret", help="Secret string used to sign payloads sent to the destination"),
    org_id: str = typer.Option(None, "--org-id", help="Organization ID to be used for this operation. If unspecifie"),
    resource_version: str = typer.Option(None, "--resource-version", help="(required) Represents version of the resource client is interested in."),
    json_body: str = typer.Option(None, "--json-body", help="Full JSON body (overrides other options)"),
    output: str = typer.Option("id", "--output", "-o", help="Output format: id|json"),
    debug: bool = typer.Option(False, "--debug"),
):
...
def update_subscriptions(
    ...
    secret: str = typer.Option(None, "--secret", help="Secret string used to sign payloads sent to the destination"),
    org_id: str = typer.Option(None, "--org-id", help="Organization ID to be used for this operation. If unspecifie"),
    resource_version: str = typer.Option(None, "--resource-version", help="Represents version of the resource client is interested in."),
    json_body: str = typer.Option(None, "--json-body", help="Full JSON body (overrides other options)"),
    debug: bool = typer.Option(False, "--debug"),
):
