...
app = typer.Typer(help="Manage Webex Calling partner-administrators.")


@app.command("list")
def cmd_list(
    managed_by: str = typer.Option(None, "--managed-by", help="List customer orgs associated with this person ID."),
