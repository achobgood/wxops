...
def create(
    ...
    number_type: str = typer.Option(None, "--number-type", help="e.g. TOLLFREE"),
    number_usage_type: str = typer.Option(None, "--number-usage-type", help="e.g. NONE"),
    state: str = typer.Option(None, "--state", help="e.g. INACTIVE"),
    subscription_id: str = typer.Option(None, "--subscription-id", help=""),
    carrier_id: str = typer.Option(None, "--carrier-id", help=""),
...
def update(
    location_id: str = typer.Argument(help="locationId"),
    action: str = typer.Option(None, "--action", help="e.g. DEACTIVATE"),
    json_body: str = typer.Option(None, "--json-body", help="Full JSON body (overrides other options)"),
    debug: bool = typer.Option(False, "--debug"),
):
...
def cmd_list(
    ...
    owner_type: str = typer.Option(None, "--owner-type", help="Returns the list of phone numbers of the given `ownerType`."),
    extension: str = typer.Option(None, "--extension", help="Returns the list of phone numbers with the given extension."),
    number_type: str = typer.Option(None, "--number-type", help="Returns the filtered list of phone numbers that contain a gi"),
    phone_number_type: str = typer.Option(None, "--phone-number-type", help="Returns the filtered list of phone numbers of the given `pho"),
    state: str = typer.Option(None, "--state", help="Returns the list of phone numbers with the matching state. R"),
...
def create_manage_numbers(
    operation: str = typer.Option(None, "--operation", help=""),
    target_location_id: str = typer.Option(None, "--target-location-id", help=""),
    number_usage_type: str = typer.Option(None, "--number-usage-type", help=""),
    json_body: str = typer.Option(None, "--json-body", help="Full JSON body (overrides other options)"),
    debug: bool = typer.Option(False, "--debug"),
):
