...
def create(
    ...
    routing_prefix: str = typer.Option(None, "--routing-prefix", help="The routing prefix is mapped to a location and can be prefix"),
    ...
    entry_point_id: str = typer.Option(None, "--entry-point-id", help="(required) The identifier of an entry point to which you want to map th"),
    entry_point_name: str = typer.Option(None, "--entry-point-name", help="(required) The entryPoint name of the entryPointId."),
    default_ani: bool = typer.Option(None, "--default-ani/--no-default-ani", help="The default dial number for the tenant to make outdial calls"),
    location: str = typer.Option(None, "--location", help="The name of the location as configured on Webex Calling(appl"),
    region_id: str = typer.Option(None, "--region-id", help="Specify the telephony region id.  You can pass id for one of"),
...
def update(
    ...
    esn: str = typer.Option(None, "--esn", help="The esn is routing prefix with extension"),
    route_point_id: str = typer.Option(None, "--route-point-id", help="The identifier of a route point of WxC which is similar to e"),
    entry_point_id: str = typer.Option(None, "--entry-point-id", help="The identifier of an entry point to which you want to map th"),
