...
def cmd_list(
    ...
    if output == "json":
        ...
        print_table(items, columns=[('ID', 'id'), ('Meeting ID', 'meetingId'), ('Title', 'title')], limit=limit)
...
def list_download(
    ...
    format_param: str = typer.Option(None, "--format", help="Format for the downloaded meeting transcript."),
...
def update(
    ...
    text: str = typer.Option(None, "--text", help=""),
