...
def cmd_list(
    ...
    url = f"https://webexapis.com/v1/hybrid/connectors"
    params = {}
    if limit > 0:
        params["max"] = limit
    if offset > 0:
    ...
    emit(items, output=output, fields=fields, columns=[('ID', 'id'), ('Hybrid Cluster ID', 'hybridClusterId'), ('Hostname', 'hostname'), ('Status', 'status'), ('Created', 'created')], limit=limit)
