...
app = typer.Typer(help="Manage Webex Calling multimedia-profile.")
...
def create(
    ...
    url = f"https://webexapis.com/v1/organization/{orgid}/multimedia-profile/bulk"
    if json_body:
...
def cmd_list(
    ...
    api = get_api(debug=debug)
    url = f"https://webexapis.com/v1/organization/{orgid}/multimedia-profile/bulk-export"
    params = {}
    if page is not None:
        params["page"] = page
...
def create_purge_inactive_entities(
    ...
    api = get_api(debug=debug)
    url = f"https://webexapis.com/v1/organization/{orgid}/multimedia-profile/purge-inactive-entities"
    params = {}
...
def show(
    ...
    api = get_api(debug=debug)
    url = f"https://webexapis.com/v1/organization/{orgid}/multimedia-profile/{id}"
    try:
...
def update(
    ...
    chat: str = typer.Option(None, "--chat", help=""),
    id_param: str = typer.Option(None, "--id", help=""),
    blending_mode: str = typer.Option(None, "--blending-mode", help=""),
    blending_mode_enabled: str = typer.Option(None, "--blending-mode-enabled", help=""),
    active: str = typer.Option(None, "--active", help=""),
    social: str = typer.Option(None, "--social", help=""),
    telephony: str = typer.Option(None, "--telephony", help=""),
...
def list_incoming_references(
    ...
    api = get_api(debug=debug)
    url = f"https://webexapis.com/v1/organization/{orgid}/multimedia-profile/{id}/incoming-references"
    params = {}
...
@app.command("list-multimedia-profile-v2")
def list_multimedia_profile_v2(
    orgid: str = typer.Argument(help="orgid"),
    ...
    api = get_api(debug=debug)
    url = f"https://webexapis.com/v1/organization/{orgid}/v2/multimedia-profile"
    params = {}
...
@app.command("list-multimedia-profile-organization")
def list_multimedia_profile_organization(
    orgid: str = typer.Argument(help="orgid"),
    filter_param: str = typer.Option(None, "--filter", help="Specify a filter based on which the results will be fetched."),
    attributes: str = typer.Option(None, "--attributes", help="Specify the attributes to be returned.Default all attributes"),
    page: str = typer.Option(None, "--page", help="Defines the number of displayed page. The page number starts"),
    ...
    """List Multimedia Profile(s)."""
    api = get_api(debug=debug)
    url = f"https://webexapis.com/v1/organization/{orgid}/multimedia-profile"
    params = {}
    if filter_param is not None:
        params["filter"] = filter_param
    if attributes is not None:
...
@app.command("create-multimedia-profile")
def create_multimedia_profile(
    orgid: str = typer.Argument(help="orgid"),
    version: str = typer.Option(None, "--version", help=""),
    system_default: str = typer.Option(None, "--system-default", help=""),
    chat: str = typer.Option(None, "--chat", help=""),
