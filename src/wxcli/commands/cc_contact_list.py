...
def create(
    ...
    activation_time_lag_minutes: str = typer.Option(None, "--activation-time-lag-minutes", help=""),
    activation_date_time: str = typer.Option(None, "--activation-date-time", help=""),
...
def update(
    ...
    contact_status: str = typer.Option(None, "--contact-status", help=""),
    json_body: str = typer.Option(None, "--json-body", help="Full JSON body (overrides other options)"),
    debug: bool = typer.Option(False, "--debug"),
):
...
def cmd_list(
    campaign_id: str = typer.Argument(help="campaignId"),
    status: str = typer.Option(None, "--status", help="Contact List Status filter (Active, Expired, UploadFailed, e"),
    source: str = typer.Option(None, "--source", help="Contact List Source filter (API, SFTP, ManualFile, GlobalUpl"),
...
def update_status(
    campaign_id: str = typer.Argument(help="campaignId"),
    contact_list_id: str = typer.Argument(help="contactListId"),
    contact_list_status: str = typer.Option(None, "--contact-list-status", help=""),
    json_body: str = typer.Option(None, "--json-body", help="Full JSON body (overrides other options)"),
    debug: bool = typer.Option(False, "--debug"),
):
