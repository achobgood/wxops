...
@app.command("list")
def cmd_list(
    from_param: str = typer.Option(None, "--from", help="The start date and time of the requested data in any [ISO 86"),
    to: str = typer.Option(None, "--to", help="The end date and time of the requested data in any [ISO 8601"),
    device_type: str = typer.Option(None, "--device-type", help="Device type(s).  - Possible values:  `webexDevices` `webexAp"),
...
def list_event_thresholds(
    event_name: str = typer.Option(None, "--event-name", help="Event name to fetch threshold details."),
    cluster_id: str = typer.Option(None, "--cluster-id", help="Unique ID of the Video Mesh Cluster."),
    event_scope: str = typer.Option(None, "--event-scope", help="Scope name to filter events."),
    output: str = typer.Option("table", "--output", "-o", help="Output format: table|json"),
    limit: int = typer.Option(0, "--limit", help="Max results (0=all for paginated endpoints, API default for non-paginated)"),
    offset: int = typer.Option(0, "--offset", help="Start offset"),
    debug: bool = typer.Option(False, "--debug"),
...
def list_clusters_client_type_distribution(
    ...
    from_param: str = typer.Option(None, "--from", help="The start date and time of the requested data in any [ISO 86"),
    to: str = typer.Option(None, "--to", help="The end date and time of the requested data in any [ISO 8601"),
    device_type: str = typer.Option(None, "--device-type", help="Device type(s).  - Possible values:     `webexDevices` `webe"),
    output: str = typer.Option("table", "--output", "-o", help="Output format: table|json"),
    limit: int = typer.Option(0, "--limit", help="Max results (0=all for paginated endpoints, API default for non-paginated)"),
    offset: int = typer.Option(0, "--offset", help="Start offset"),
    debug: bool = typer.Option(False, "--debug"),
...
def list_nodes_network_test(
    node_id: str = typer.Option(None, "--node-id", help="Unique ID of the Video Mesh node."),
    trigger_type: str = typer.Option(None, "--trigger-type", help="Trigger type."),
    from_param: str = typer.Option(None, "--from", help="The start date and time of the requested data in any [ISO 86"),
    to: str = typer.Option(None, "--to", help="The end date and time of the requested data in any [ISO 8601"),
    output: str = typer.Option("table", "--output", "-o", help="Output format: table|json"),
    limit: int = typer.Option(0, "--limit", help="Max results (0=all for paginated endpoints, API default for non-paginated)"),
...
def list_test_results(
    command_id: str = typer.Option(None, "--command-id", help="The unique command ID generated from Trigger on-demand test"),
    output: str = typer.Option("table", "--output", "-o", help="Output format: table|json"),
    limit: int = typer.Option(0, "--limit", help="Max results (0=all for paginated endpoints, API default for non-paginated)"),
    offset: int = typer.Option(0, "--offset", help="Start offset"),
    debug: bool = typer.Option(False, "--debug"),
...
@app.command("list-availability-clusters")
def list_availability_clusters(
    from_param: str = typer.Option(None, "--from", help="The starting date and time of the requested data in any [ISO"),
    to: str = typer.Option(None, "--to", help="The ending date and time of the requested data in any [ISO 8"),
    output: str = typer.Option("table", "--output", "-o", help="Output format: table|json"),
    limit: int = typer.Option(0, "--limit", help="Max results (0=all for paginated endpoints, API default for non-paginated)"),
    offset: int = typer.Option(0, "--offset", help="Start offset"),
    debug: bool = typer.Option(False, "--debug"),
...
def list_call_redirects_clusters(
    from_param: str = typer.Option(None, "--from", help="The starting date and time of the requested data in any [ISO"),
    to: str = typer.Option(None, "--to", help="The ending date and time of the requested data in any [ISO 8"),
    cluster_id: str = typer.Option(None, "--cluster-id", help="The unique Video Mesh Cluster ID."),
    output: str = typer.Option("table", "--output", "-o", help="Output format: table|json"),
    limit: int = typer.Option(0, "--limit", help="Max results (0=all for paginated endpoints, API default for non-paginated)"),
    offset: int = typer.Option(0, "--offset", help="Start offset"),
    debug: bool = typer.Option(False, "--debug"),
...
@app.command("list-availability-nodes")
def list_availability_nodes(
    from_param: str = typer.Option(None, "--from", help="The starting date and time of the requested data in any [ISO"),
    to: str = typer.Option(None, "--to", help="The ending date and time of the requested data in any [ISO 8"),
    cluster_id: str = typer.Option(None, "--cluster-id", help="The unique Video Mesh cluster ID."),
    output: str = typer.Option("table", "--output", "-o", help="Output format: table|json"),
...
@app.command("show-availability-clusters")
def show_availability_clusters(
    cluster_id: str = typer.Argument(help="clusterId"),
    from_param: str = typer.Option(None, "--from", help="The starting date and time of the requested data in any [ISO"),
    to: str = typer.Option(None, "--to", help="The ending date and time of the requested data in any [ISO 8"),
    output: str = typer.Option("json", "--output", "-o", help="Output format: table|json"),
...
@app.command("show-availability-nodes")
def show_availability_nodes(
    node_id: str = typer.Argument(help="nodeId"),
    from_param: str = typer.Option(None, "--from", help="The starting date and time of the requested data in any [ISO"),
    to: str = typer.Option(None, "--to", help="The ending date and time of the requested data in any [ISO 8"),
    output: str = typer.Option("json", "--output", "-o", help="Output format: table|json"),
