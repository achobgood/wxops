...
def cmd_list(
    ...
    emit(items, output=output, fields=fields, columns=[('ID', 'id'), ('Person Email', 'personEmail'), ('Text', 'text')], limit=limit)
...
def update(
    ...
    if result:
        ...
        emit({"status": "updated", "id": message_id}, output=output, fields=fields)
