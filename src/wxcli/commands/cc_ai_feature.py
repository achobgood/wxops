...
def cmd_list(
    ...
    emit(items, output=output, fields=fields, columns=[('ID', 'id'), ('Organization ID', 'organizationId'), ('Version', 'version'), ('Created Time', 'createdTime'), ('Last Updated Time', 'lastUpdatedTime')], limit=limit)
