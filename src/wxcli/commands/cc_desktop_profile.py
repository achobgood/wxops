...
def create_agent_profile(
    ...
    """Create a new Desktop Profile\n\nExample --json-body:\n  '{"agentDNValidationCriteria":"...","agentDNValidationCriterions":["..."],"loginVoiceOptions":["..."],"thresholdRules":["..."],"timeoutDesktopInactivityCustomEnabled":"...","showUserDetailsMS":"...","stateSynchronizationMS":"...","parentType":"..."}'."""
    api = get_api(debug=debug)
    cc_base_url = get_cc_base_url()
    orgid = get_org_id() or api.people.me().org_id
    url = f"{cc_base_url}/organization/{orgid}/agent-profile"
