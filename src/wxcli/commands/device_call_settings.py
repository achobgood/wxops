...
def update_devices(
    ...
    guest_hours_limit: str = typer.Option(None, "--guest-hours-limit", help=""),
    json_body: str = typer.Option(None, "--json-body", help="Full JSON body (overrides other options)"),
    debug: bool = typer.Option(False, "--debug"),
):
...
@app.command("create")
def create(
    template_name: str = typer.Option(None, "--template-name", help=""),
    device_model: str = typer.Option(None, "--device-model", help=""),
    user_reorder_enabled: bool = typer.Option(None, "--user-reorder-enabled/--no-user-reorder-enabled", help=""),
    json_body: str = typer.Option(None, "--json-body", help="Full JSON body (overrides other options)"),
    debug: bool = typer.Option(False, "--debug"),
):
...
def preview_apply_line(
    action: str = typer.Option(None, "--action", help="e.g. APPLY_TEMPLATE"),
    template_id: str = typer.Option(None, "--template-id", help=""),
    exclude_devices_with_custom_layout: str = typer.Option(None, "--exclude-devices-with-custom-layout", help=""),
    json_body: str = typer.Option(None, "--json-body", help="Full JSON body"),
    debug: bool = typer.Option(False, "--debug"),
):
...
def create_apply_line_key_template(
    action: str = typer.Option(None, "--action", help="e.g. APPLY_TEMPLATE"),
    template_id: str = typer.Option(None, "--template-id", help=""),
    exclude_devices_with_custom_layout: bool = typer.Option(None, "--exclude-devices-with-custom-layout/--no-exclude-devices-with-custom-layout", help=""),
    json_body: str = typer.Option(None, "--json-body", help="Full JSON body (overrides other options)"),
    debug: bool = typer.Option(False, "--debug"),
):
...
def create_call_device_settings(
    ...
    location_customizations_enabled: bool = typer.Option(None, "--location-customizations-enabled/--no-location-customizations-enabled", help=""),
    json_body: str = typer.Option(None, "--json-body", help="Full JSON body (overrides other options)"),
    debug: bool = typer.Option(False, "--debug"),
):
...
def update_layout(
    device_id: str = typer.Argument(help="deviceId"),
    layout_mode: str = typer.Option(None, "--layout-mode", help="e.g. DEFAULT"),
    user_reorder_enabled: bool = typer.Option(None, "--user-reorder-enabled/--no-user-reorder-enabled", help=""),
    kem_module_type: str = typer.Option(None, "--kem-module-type", help="e.g. KEM_18_KEYS"),
    json_body: str = typer.Option(None, "--json-body", help="Full JSON body (overrides other options)"),
    debug: bool = typer.Option(False, "--debug"),
):
