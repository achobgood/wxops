...
app = typer.Typer(help="Manage Webex Calling skill.")
...
def cmd_list(
    ...
    url = f"https://webexapis.com/v1/organization/{orgid}/skill"
    params = {}
...
def create_bulk(
    ...
    api = get_api(debug=debug)
    url = f"https://webexapis.com/v1/organization/{orgid}/skill/bulk"
    if json_body:
        body = json.loads(json_body)
    else:
        body = {}
...
def list_bulk_export(
    ...
    """Bulk export Skill(s)."""
    api = get_api(debug=debug)
    url = f"https://webexapis.com/v1/organization/{orgid}/skill/bulk-export"
    params = {}
    if page is not None:
        params["page"] = page
    if page_size is not None:
...
def create_purge_inactive_entities(
    ...
    api = get_api(debug=debug)
    url = f"https://webexapis.com/v1/organization/{orgid}/skill/purge-inactive-entities"
    params = {}
...
def show(
    ...
    api = get_api(debug=debug)
    url = f"https://webexapis.com/v1/organization/{orgid}/skill/{id}"
    try:
...
def list_incoming_references(
    ...
    api = get_api(debug=debug)
    url = f"https://webexapis.com/v1/organization/{orgid}/skill/{id}/incoming-references"
    params = {}
...
def list_skill(
    ...
    """List Skill(s)."""
    api = get_api(debug=debug)
    url = f"https://webexapis.com/v1/organization/{orgid}/v2/skill"
    params = {}
    if filter_param is not None:
        params["filter"] = filter_param
    if attributes is not None:
