...
def create(
    ...
    site_list: str = typer.Option(None, "--site-list", help="Sites belonging to user's organization. This attribute is needed for site-based templates."),
    time_zone: str = typer.Option(None, "--time-zone", help="Time zone used for report date and time values. Use an IANA time zone name. This field is optional."),
