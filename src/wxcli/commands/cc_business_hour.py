...
@app.command("list", short_help="List Business Hours resources.")
def cmd_list(
...
@app.command("show", short_help="Get specific Business Hours resource by ID.")
def show(
    id: str = typer.Argument(help="UUID, from: wxcli cc-business-hour list"),
    output: str = typer.Option("json", "--output", "-o", help="Output format: table|json|text"),
    fields: str = typer.Option(None, "--fields", help="JMESPath expression selecting/filtering response fields, e.g. \"[].{name:name,id:id}\""),
    debug: bool = typer.Option(False, "--debug"),
):
    """Get specific Business Hours resource by ID.\n\n\b\nExample: wxcli cc-business-hour show ID"""
    api = get_api(debug=debug)
    cc_base_url = get_cc_base_url()
    orgid = get_cc_org_id(api.session)
...
@app.command("delete", short_help="Delete specific Business Hours resource by ID.")
def delete(
    id: str = typer.Argument(help="UUID, from: wxcli cc-business-hour list"),
...
@app.command("list-incoming-references", short_help="List references for a specific Business Hours resource.")
def list_incoming_references(
    ...
    """List references for a specific Business Hours resource.\n\n\b\nExample: wxcli cc-business-hour list-incoming-references ID"""
    api = get_api(debug=debug)
    cc_base_url = get_cc_base_url()
    orgid = get_cc_org_id(api.session)
...
@app.command("list-business-hours", short_help="List Business Hours resources.")
