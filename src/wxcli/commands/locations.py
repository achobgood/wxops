...
def cmd_list(
    ...
    emit(items, output=output, fields=fields, columns=[('ID', 'id'), ('Display Name', 'displayName'), ('Location ID', 'locationId'), ('Address', 'address'), ('Country Code', 'countryCode')], limit=limit)
