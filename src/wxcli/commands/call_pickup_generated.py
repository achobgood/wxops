...
def create(
    ...
    notification_type: str = typer.Option(None, "--notification-type", help="e.g. NONE"),
    notification_delay_timer_seconds: str = typer.Option(None, "--notification-delay-timer-seconds", help=""),
...
def update(
    ...
    call_pickup_id: str = typer.Argument(help="callPickupId"),
    name: str = typer.Option(None, "--name", help=""),
    notification_type: str = typer.Option(None, "--notification-type", help="e.g. AUDIO_AND_VISUAL"),
    notification_delay_timer_seconds: str = typer.Option(None, "--notification-delay-timer-seconds", help=""),
    json_body: str = typer.Option(None, "--json-body", help="Full JSON body (overrides other options)"),
    debug: bool = typer.Option(False, "--debug"),
):
