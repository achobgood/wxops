...
@app.command("list-recordings-admin", short_help="List Recordings For an Admin or Compliance Officer.")
...
@app.command("delete", short_help="Delete a Recording By an Admin.")
def delete(
    recording_id: str = typer.Argument(help="from: wxcli admin-recordings list-recordings-admin"),
...
def show(
    ...
    """Get Recording Details.\n\n\b\nExample: wxcli admin-recordings show RECORDING_ID"""
    api = get_api(debug=debug)
...
def delete_recordings(
    ...
    """Delete a Recording.\n\n\b\nExample: wxcli admin-recordings delete-recordings RECORDING_ID\n\n\b\nExample --json-body: '{"reason":"...","comment":"..."}'"""
    if generate_json_body:
...
def create_restore(
    ...
    """Restore Recordings from Recycle Bin.\n\n\b\nExample --json-body: '{"restoreAll":true,"recordingIds":["..."],"siteUrl":"..."}'"""
    if generate_json_body:
...
def delete_recordings_recycle(
    ...
    """Purge Recordings from Recycle Bin.\n\n\b\nExample --json-body: '{"purgeAll":true,"recordingIds":["..."],"siteUrl":"..."}'"""
    if generate_json_body:
...
@app.command("create-access-list-recordings", short_help="Share a Recording.")
def create_access_list_recordings(
    ...
    """Share a Recording.\n\n\b\nExample: wxcli admin-recordings create-access-list-recordings RECORDING_ID\n\n\b\nExample --json-body: '{"hostEmail":"...","addEmails":["..."],"removeEmails":["..."],"sendEmail":true}'"""
    if generate_json_body:
...
@app.command("create-access-list-recordings-1", short_help="Share a Recording Link.")
def create_access_list_recordings_1(
    ...
    """Share a Recording Link.\n\n\b\nExample --json-body: '{"hostEmail":"...","webShareLink":"...","addEmails":["..."],"removeEmails":["..."],"sendEmail":true}'"""
    if generate_json_body:
...
@app.command("list-recordings-group", short_help="List Group Recordings.")
...
@app.command("show-recordings", short_help="Get Group Recording Details.")
def show_recordings(
    recording_id: str = typer.Argument(help="from: wxcli admin-recordings list-recordings-group"),
    person_id: str = typer.Option(None, "--person-id", help="Person ID of the user whose recordings will be retrieved. The person ID can be retrieved from the [People APIs](/docs/api/v1/people), e.g. [Lit People](/docs/api/v1/people/list-people). Note that a person ID retrieved from the People APIs is a Base64-encoded string, e.g...."),
    output: str = typer.Option("json", "--output", "-o", help="Output format: table|json|text"),
    fields: str = typer.Option(None, "--fields", help="JMESPath expression selecting/filtering response fields, e.g. \"[].{name:name,id:id}\""),
    debug: bool = typer.Option(False, "--debug"),
):
    """Get Group Recording Details.\n\n\b\nExample: wxcli admin-recordings show-recordings RECORDING_ID"""
    api = get_api(debug=debug)
