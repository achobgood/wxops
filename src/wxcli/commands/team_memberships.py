...
def cmd_list(
    ...
    emit(items, output=output, fields=fields, columns=[('ID', 'id'), ('Person Display Name', 'personDisplayName'), ('Team ID', 'teamId'), ('Person ID', 'personId'), ('Person Email', 'personEmail')], limit=limit)
