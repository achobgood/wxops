...
def cmd_list(
    ...
    url = f"https://webexapis.com/v1/hybrid/clusters"
    params = {}
    if limit > 0:
        params["max"] = limit
    if offset > 0:
    ...
    emit(items, output=output, fields=fields, columns=[('ID', 'id'), ('Name', 'name'), ('Resource Group ID', 'resourceGroupId')], limit=limit)
