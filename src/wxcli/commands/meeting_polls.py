...
app = typer.Typer(help="Manage Webex Calling meeting-polls.")


@app.command("list")
def cmd_list(
    meeting_id: str = typer.Option(None, "--meeting-id", help="A unique identifier for the [meeting instance](/docs/meeting"),
    max: str = typer.Option(None, "--max", help="Limit the maximum number of respondents in a meeting in the"),
...
def list_respondents(
    ...
    meeting_id: str = typer.Option(None, "--meeting-id", help="A unique identifier for the [meeting instance](/docs/meeting"),
    max: str = typer.Option(None, "--max", help="Limit the maximum number of respondents in a specified quest"),
    output: str = typer.Option("table", "--output", "-o", help="Output format: table|json"),
    limit: int = typer.Option(0, "--limit", help="Max results (0=all for paginated endpoints, API default for non-paginated)"),
    offset: int = typer.Option(0, "--offset", help="Start offset"),
    debug: bool = typer.Option(False, "--debug"),
