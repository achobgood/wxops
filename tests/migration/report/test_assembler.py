...
class TestAssembler:
    ...
    def test_sidebar_has_section_w(self, populated_store):
        """Sidebar nav includes section W for DECT Networks."""
        from wxcli.migration.report.assembler import assemble_report

        html = assemble_report(populated_store, brand="Acme Corp", prepared_by="Test SE")
