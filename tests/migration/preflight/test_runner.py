...
def _seed_basic_store(store):
    ...
    # Provide an ECBN config for the user so check_e911_readiness passes
    store.upsert_object(_analyzed(CanonicalEcbnConfig(
        canonical_id="ecbn:user:001", provenance=_prov(),
        entity_type="user", entity_canonical_id="user:001",
        ecbn_selection="DIRECT_LINE", primary_did="+14085551234",
    )))
