...
class TestParseParameters:
    def test_path_param_extracted(self, spec):
        ...
        path_vars, query_params, auto_inject, auto_inject_path = parse_parameters(params, spec)
    ...
    def test_query_params_extracted(self, spec):
        ...
        path_vars, query_params, auto_inject, auto_inject_path = parse_parameters(
    ...
    def test_query_param_types(self, spec):
        params = spec["paths"]["/v1/things"]["get"]["parameters"]
        _, query_params, _, _ = parse_parameters(params, spec, omit_query_params=["orgId"])
    ...
    def test_omit_query_params(self, spec):
        params = spec["paths"]["/v1/things"]["get"]["parameters"]
        _, query_params, _, _ = parse_parameters(params, spec, omit_query_params=["orgId", "max"])
        names = [qp.name for qp in query_params]
        assert "orgId" not in names
...
def test_parse_parameters_no_auto_inject():
    ...
    path_vars, query_params, auto_inject, auto_inject_path = parse_parameters(params, {})
